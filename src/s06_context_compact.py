...
3. when the whole conversation gets too large, the agent summarizes it and continues from the summary

the goal is not to model every production branch. the goal is to make the active context
ideas explicit and teachable
"""
import json
import os
import subprocess
